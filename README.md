...
- `@mercado-facil/ui`: a stub React component library shared by both `web` and
  `docs` applications
- `@mercado-facil/eslint-config`: `eslint` configurations (includes
  `eslint-config-next` and `eslint-config-prettier`)
- `@mercado-facil/typescript-config`: `tsconfig.json`s used throughout the
  monorepo
...
[Remote Caching](https://turborepo.dev/docs/core-concepts/remote-caching) to
