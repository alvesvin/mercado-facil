...
export const ZAiProductInfo = z.object({
  ...
  flavor: z
    .string()
    .nullish()
    .describe('O sabor do produto. Exemplo em um suco de laranja, o sabor é "Laranja".'),
  quantityUnit: z.enum(["unit", "kg", "g", "mg", "lb", "oz", "ml", "l", "gal"]).nullish(),
  quantity: z
    .number()
    .nullish()
    .describe(
  ...
  category: z
    .string()
    .nullish()
    .describe("A categoria do produto. Escolha a categoria mais apropriada para o produto."),
  subCategory: z
    .string()
    .nullish()
    .describe("A subcategoria do produto. Escolha a subcategoria mais apropriada para o produto."),
});
