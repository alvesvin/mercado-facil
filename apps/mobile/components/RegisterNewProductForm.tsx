...
export function RegisterNewProductForm(props: Props) {
  ...
  const form = useForm({
    ...
    defaultValues: initialValues as RegisterNewProductFormSchema,
  });
  ...
  return (
    <>
      <ScrollView className="pt-12 flex-1">
        <View className="gap-6">
                ...
                render={({ field }) => {
                  return (
                    <Select onValueChange={field.onChange} value={field.value}>
                      ...
                      <SelectContent>
                        <SelectItem label="Por unidade" value="unit">
                          Por unidade
                        </SelectItem>
                        <SelectItem label="Por quilo" value="per_kg">
                          Por quilo
                        </SelectItem>
                        <SelectItem label="Por litro" value="per_l">
                          Por litro
                        </SelectItem>
                      </SelectContent>
                    </Select>
          ...
          <View>
            ...
            <Controller
              ...
              name="name"
              render={({ field }) => {
                return <Input {...field} placeholder="Macarrão instantâneo" />;
              }}
            />
          </View>
          <View>
            ...
            <Controller
              ...
              name="brand"
              render={({ field }) => {
                return <Input {...field} placeholder="Nissin" />;
              }}
            />
          </View>
          <View>
            ...
            <Controller
              ...
              name="flavor"
              render={({ field }) => {
                return <Input {...field} value={field.value ?? undefined} placeholder="Limão" />;
              }}
            />
          </View>
          <Separator className="mt-2" />
          ...
          <View>
            ...
            <Controller
              ...
              render={({ field }) => {
                return (
                  <Input {...field} value={field.value ?? undefined} placeholder="Alimentos" />
                );
              }}
            />
          </View>
          <View>
            ...
            <Controller
              ...
              name="subCategory"
              render={({ field }) => {
                return <Input {...field} value={field.value ?? undefined} placeholder="Macarrão" />;
              }}
            />
          </View>
        </View>
